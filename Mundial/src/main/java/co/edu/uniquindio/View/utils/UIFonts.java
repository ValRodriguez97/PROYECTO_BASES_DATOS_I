...
public class UIFonts {
      ...
      public static final Font HEADING_XL   = new Font(BASE, Font.BOLD,   24);
      public static final Font HEADING_LG   = new Font(BASE, Font.BOLD,   20);
      public static final Font HEADING_MD   = new Font(BASE, Font.BOLD,   16);
      public static final Font HEADING_SM   = new Font(BASE, Font.BOLD,   14);
      ...
      public static final Font STAT_NUMBER  = new Font(BASE, Font.BOLD,   28);
      public static final Font STAT_LABEL   = new Font(BASE, Font.PLAIN,  12);
